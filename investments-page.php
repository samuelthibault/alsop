...
<?php echo get_post_meta($post->ID, "LogoLink", true); ?>
<?php if( get_post_meta($post->ID, "Logo", true) ): ?>
<a href="<?php echo get_post_meta($post->ID, "LogoLink", true); ?>"><img class="logo-investments" src="<?php echo get_post_meta($post->ID, "Logo", true); ?>"></a>
<?php endif; ?>
